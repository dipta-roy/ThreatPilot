...
1. To confirm the application is genuine, right click on ThreatPilot-1.6.1-win64.msi and click on Properties.
...
Once verified,
```
Run ThreatPilot-1.6.1-win64.msi and install the application.
```
