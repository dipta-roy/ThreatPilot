...
<body>
  <div class="card">
    ...
    <p>Please enter the 6-digit PIN generated by the ThreatPilot desktop application to access this visual architecture model.</p>
    <input type="text" id="pin" maxlength="6" placeholder="000000" autocomplete="off" />
    ...
    async function verifyPin() {
      ...
      try {
        ...
        if (res.ok) {
          ...
          document.cookie = `threatpilot_session=${data.token}; path=/; SameSite=Strict`;
