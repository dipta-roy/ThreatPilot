...
class PromptSettingsDialog(QDialog):
    ...
    def _setup_ui(self) -> None:
        ...
        self._risk_preference.addItems(["High", "Medium", "Low"])
        pref = self._config.risk_preference.capitalize()
        self._risk_preference.setCurrentText(pref if pref in ["High", "Medium", "Low"] else "Medium")
        ...
        self._business_context.setPlaceholderText("e.g. Data must never leave the VPC or Region, All PII must be encrypted at rest...")
